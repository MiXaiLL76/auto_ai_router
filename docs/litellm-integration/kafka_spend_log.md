...
| `error_body_raw`                                                                                                                                                                                                                                                                                                                                                                                                                                       | string, omitempty   | Untruncated upstream provider error body (up to 16 KiB). Only present when `status == "failure"` — always absent on success, unlike `error_message` which is capped at 512 bytes for readability |
